...
<div class="panel panel-primary with-margin">
    <div class="panel-heading">
        <h3 class="panel-title">录入服务员信息</h3>
    </div>
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="{{ action('Api\Restaurant\WaiterController@store') }}">
            {{--服务员编号--}}
            <div class="form-group">
                <label for="waiter-id" class="col-sm-2 control-label">服务员编号(必填):</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="waiter-id" name="waiter-id"
                           placeholder="请输入服务员编号, 例如: ABCDEFG123" required>
                </div>
            </div>
            {{--服务员所属餐厅--}}
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    placeholder="请输入服务员所属餐厅编号, 例如: 1, 2, 3..." required>
                </div>
            </div>
            {{--服务员名字--}}
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="birthday" name="birthday"
                           placeholder="请输入服务员出生日期, 例如: 2017-05-12" required>
                </div>
            </div>
            {{--职称--}}
            <div class="form-group">
